...
import it.vfsfitvnm.core.ui.favoritesIcons
    ...
    Box(
        ...
        LazyColumn(
            ...
            items(
                ...
                var likedAt by remember { mutableStateOf<Long?>(song.likedAt) }

                LaunchedEffect(song.id) {
                    Database.instance.likedAt(song.id).collectLatest { likedAt = it }
                }
